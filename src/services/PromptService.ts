export const newRecipeByVisionPrompt = `You are a expert scribe and you have to write down the recipe in the image.
                  ...
                  If you are not sure about a word or a step, write something that make sens with the context.
                  ...
                  If one or more field are not present, write something that make sens with the context.
